...
export class HierarchicalClustering implements Comparable<HierarchicalClustering> {
    ...
    toString()
    toString(indent: string, showCreatedFrom: boolean, showCreatedFromRecursively: boolean, limit: number)
    toString(indent: string = "", showCreatedFrom: boolean = true, showCreatedFromRecursively: boolean = true, limit: number = -1) {
